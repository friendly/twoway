...
## MF:
# Are you suggesting a 'jitter' argument here?
# In this example, the slope is close to zero, so it doesn't matter much.
# The median method is of course more susceptible to overplotting.
